---
name: cfc-acceptance-criteria
description: add or update QA team (human tested) acceptance criteria on linear ticket
---

# Add or update acceptance criteria

Given a linear ticket id or url, read the acceptance criteria in the ticket description.
